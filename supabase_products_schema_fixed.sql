...
-- VERSIÓN CORREGIDA - Sin foreign keys incompatibles

-- 1. TABLA DE PRODUCTOS (Cache de Shopify)
CREATE TABLE IF NOT EXISTS products (
  id text PRIMARY KEY,                    -- Shopify product ID (text)
  store_domain text NOT NULL,             -- Domain de la tienda (sin FK por tipo incompatible)
  title text NOT NULL,
  description text,
...
CREATE TABLE IF NOT EXISTS product_variants (
  id text PRIMARY KEY,                    -- Shopify variant ID (text)
  product_id text NOT NULL,               -- FK to products.id (ambos text, compatibles)
...
CREATE TABLE IF NOT EXISTS sync_logs (
  ...
  store_domain text NOT NULL,              -- Domain de la tienda (sin FK)
