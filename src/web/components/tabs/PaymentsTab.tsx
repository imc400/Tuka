        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-white/90 text-sm">
              ...
              su comisión ({((store.commission_rate ?? 0) * 100).toFixed(1).replace(/\.0$/, '')}%) y tú recibes el resto al instante.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-700">
                    {((store.commission_rate ?? 0) * 100).toFixed(1).replace(/\.0$/, '')}% por venta
                  </p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-700 mt-2 space-y-1 list-disc list-inside">
              ...
              <li>Grumo cobra automáticamente su comisión ({((store.commission_rate ?? 0) * 100).toFixed(1).replace(/\.0$/, '')}%)</li>
